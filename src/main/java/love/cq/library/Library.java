...
public class Library {
	...
	public synchronized static void insertWord(Forest forest, Value value) {
	 ...
	 * @param temp
	 */
	public synchronized static void insertWord(WoodInterface forest, String temp) {
	 ...
	 * @param temp
	 */
	public synchronized static void removeWord(Forest forest, String word) {
		WoodInterface branch = forest;
